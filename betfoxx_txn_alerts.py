...
if txns is not None and txns.shape[0] > 0:
    ...
    sender = "sakethg250@gmail.com"
    recipients = ["saketh@crystalwg.com","SANDRA@CRYSTALWG.COM","ron@crystalwg.com","camila@crystalwg.com","celeste@crystalwg.com","cristina@crystalwg.com","lina.betcoco@gmail.com","erika@crystalwg.com"]
    password = "xjyb jsdl buri ylqr"
